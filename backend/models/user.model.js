...
const userSchema = new Schema({
  ...
  role: {type: String, default: "club-secretary",enum: ["club-secretary", "general-secretary", "treasurer", "president", "ARSW", "associate-dean", "associate-dean-socio-cultural", "dean"]},
  type: {
    type: String,
